<html>
  ...
  <?php
  $nilaiJual = $_POST['penjualan']; // membaca nilai penjualan H
  ...
  echo "<p>Nilai penjualan salesman : Rp. ".$nilaiJual."</p>"; // menampilkan nilai penjualan salesman echo "<p>Prosentase Komisi: ".$prosenkomisi."</p>"; // menampilkan nilai prosentase komisi salesman echo "<p>Komisi yang didapat salesman adalah Rp. .$komisi."</p>"; // menampilkan hasil perhitungan komisi
